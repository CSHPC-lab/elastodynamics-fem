...
#pragma omp parallel for
    ...
    double *M_val = new double[nnz_M_scalar];
    build_scalar_csr_M(num_nodes, nnz_bcrs, brp, bci, bmval, M_rp, M_ci, M_val);
    ...
    double *K_val = new double[nnz_K_scalar];
    build_scalar_csr_K(num_nodes, nnz_bcrs, brp, bci,
                       bk00, bk01, bk02, bk10, bk11, bk12, bk20, bk21, bk22,
                       K_rp, K_ci, K_val);

    printf("Scalar CSR K: rows=%d, nnz=%d\n", N3, nnz_K_scalar);
