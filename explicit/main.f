c      parameter(nex=301,ney=301,nez=150,kd=2,nt=10000)
c      parameter(nex=201,ney=201,nez=100,kd=2,nt=10000)
c      parameter(nex=721,ney=721,nez=350,kd=1,nt=100000,nobs=3)
